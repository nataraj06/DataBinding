...
import com.android.databinding.databinding.DataBindingActivity2Binding;
import com.android.databinding.model.DataModel;
...
public class DataBindingActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DataModel dataModel = new DataModel("Data binding", "If you realized the advantage of Data Binding already — it’s you have 2 lines of code max.You just save that binding variable as field if you need and can assess any of you fields anywhere within this class");
